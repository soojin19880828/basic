package com.thfdcsoft.estate.printer.constant;
...
//
//		public static final String YUNMAI_ROOT = PropertyFactory.getPath() + "yunmai";
//	}
	...
	// 日志相关文件目录
		...
		public interface TerminalInfo {
			public static final String DJZM_TYPE = PropertyFactory.properties.getProperty("djzmTerminal");
			public static final String QZS_TYPE = PropertyFactory.properties.getProperty("qzsTerminal");
		}
