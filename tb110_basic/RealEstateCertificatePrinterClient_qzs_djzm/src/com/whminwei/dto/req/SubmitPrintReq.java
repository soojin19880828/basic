...
public class SubmitPrintReq {
	...
	public String toString() {
		return "SubmitPrintReq [busiNumber=" + busiNumber + ", certNumber=" + certNumber + ", sequNumber=" + sequNumber
				+ ", certScan=" + certScan + ", UsageId=" + UsageId + ", destPath=" + destPath + ", ocrPicPath="
				+ ocrPicPath + ", logFile=" + logFile + ", terminalId=" + terminalId + "]";
	}
