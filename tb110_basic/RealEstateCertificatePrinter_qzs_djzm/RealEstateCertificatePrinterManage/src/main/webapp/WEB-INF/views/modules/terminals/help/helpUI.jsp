...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include
								page="/WEB-INF/views/modules/terminals/help/helpList.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/terminals/help/helpEdit.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/modules/terminals/help.js"
		type="text/javascript"></script>
