...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include
								page="/WEB-INF/views/modules/terminals/print/printList.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/terminals/print/printDetail.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/terminals/print/addPrintDetail.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/laydate/laydate.js"></script>
	<script src="${ctxResources}/pages/bootBox/bootbox.min.js"></script>
	<script src="${ctxResources}/pages/bootBox/bootbox.locales.min.js"></script>
	<script src="${ctxResources}/pages/bootBox/bootbox.all.min.js"></script>

	<script src="${ctxResources}/pages/menu.js" type="text/javascript"></script>
	<script src="${ctxResources}/pages/modules/terminals/zmPrint.js"
		type="text/javascript"></script>
