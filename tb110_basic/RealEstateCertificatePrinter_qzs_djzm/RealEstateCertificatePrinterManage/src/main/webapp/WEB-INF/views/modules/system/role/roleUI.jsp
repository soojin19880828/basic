...
<link type="text/css"
	...
	rel="stylesheet">
	<link type="text/css"
	href="${ctxResources}/css/zTree/zTreeStyle.css"
	rel="stylesheet">
<link type="text/css"
...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include
								page="/WEB-INF/views/modules/system/role/roleList.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/system/role/roleEdit.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/system/role/authorize.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/modules/system/roles.js"
		type="text/javascript"></script>
