...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include
								page="/WEB-INF/views/modules/org/org/orgList.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/org/org/orgEdit.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/modules/org/org.js"
		type="text/javascript"></script>
