...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include
								page="/WEB-INF/views/modules/org/agent/agentList.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/org/agent/agentEdit.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/modules/org/agent.js"
		type="text/javascript"></script>
