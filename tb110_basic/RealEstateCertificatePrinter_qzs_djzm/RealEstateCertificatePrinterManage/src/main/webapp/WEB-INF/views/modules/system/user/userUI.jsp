...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include
								page="/WEB-INF/views/modules/system/user/userList.jsp"></jsp:include>
							<jsp:include
								page="/WEB-INF/views/modules/system/user/userEdit.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/modules/system/users.js"
		type="text/javascript"></script>
