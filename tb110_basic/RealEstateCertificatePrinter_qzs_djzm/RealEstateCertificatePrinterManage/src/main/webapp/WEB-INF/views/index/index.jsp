...
<body>
				...
				<div class="span9">
					<div class="content">
						<div class="module message">
							<jsp:include page="/WEB-INF/views/index/module-head.jsp"></jsp:include>
							<jsp:include page="/WEB-INF/views/index/module-body.jsp"></jsp:include>
						</div>
					</div>
				</div>
			</div>
	...
	<script src="${ctxResources}/pages/index/terminals.js"
