...
public class DjzmQueryResultDto {
    ...
    private List<DjzmBdcdyxxInfo> bdcdyxx;
    ...
    public List<DjzmQlrInfo> getQlr() {
        return qlr;
    }

    public void setQlr(List<DjzmQlrInfo> qlr) {
        this.qlr = qlr;
    }
    ...
    public List<DjzmBdcdyxxInfo> getBdcdyxx() {
        return bdcdyxx;
    }

    public void setBdcdyxx(List<DjzmBdcdyxxInfo> bdcdyxx) {
